...
function createFeatures(earthquakeData)
{
    ...
    // use L.geoJSON to make the geoJSON maker layer
    var earthquakes = L.geoJSON(earthquakeData, {
        onEachFeature: onEachFeature // onEachFeature (left) is the property for the marker layer
                                    // onEachFeature (right) is the function applied to the marker layer
    });
