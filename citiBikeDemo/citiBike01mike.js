// performaing an API call to the CitiBike API and process data
...
{
    console.log(bikeData); // returns an array of data -> where the array is stored in .data.stations

    // pull the stations property to get the array
    var stations = bikeData.data.stations;

    // create the markers
    // make an empty array so we can toggle the markers
    var bikeMarkers = [];

    // populate the bikeMarkers array by looping throught the array of stations
    ...
    // finally call the fucntion to create the map and paass in the markers
