...
d3.json(dataURL).then(
    function(data)
    {
        // make an marker cluster group to hold the cluster of points
        ...
        for (var i = 0; i < data.length; i++)
        {
            ...
            // add the coordinates as an arry to the marker clusters and add a popup
            markers.addLayer(
                L.marker(
                    [
        ...
        // us .addLayer() to add the marker cluster to map
